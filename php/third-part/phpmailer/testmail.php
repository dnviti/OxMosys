...
try {
    ...
    $mail->Username = 'dnviti@mail.com';                 // SMTP username
    $mail->Password = 'j2q7jzux';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('dnviti@mail.com', 'Mailer');
    $mail->addAddress('dnviti@gmail.com', 'Joe User');     // Add a recipient
